...
-- Schema for storing DBT Projects
...
GRANT USAGE ON DATABASE APJ_TECHUP_FY26__SINGAPORE_TAXI_DATASET TO ROLE TECHUP25_RL;
GRANT USAGE ON SCHEMA APJ_TECHUP_FY26__SINGAPORE_TAXI_DATASET.RAW_DATA TO ROLE TECHUP25_RL;
GRANT SELECT ON ALL TABLES IN SCHEMA APJ_TECHUP_FY26__SINGAPORE_TAXI_DATASET.RAW_DATA TO ROLE TECHUP25_RL;
...
-- Git API integration to fetch project from Github
CREATE OR REPLACE API INTEGRATION techup_dbt_hol_api_integration
